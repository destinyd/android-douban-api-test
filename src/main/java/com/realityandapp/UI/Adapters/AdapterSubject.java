...
public class AdapterSubject extends SingleTypeAdapter<Subject> {
    private final ImageLoader avatars;

    public AdapterSubject(LayoutInflater inflater, List<Subject> items, ImageLoader avatars) {
     ...
     * @param items
     */
    public AdapterSubject(LayoutInflater inflater, List<Subject> items) {
